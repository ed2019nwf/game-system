<template>
  <div class="table-data">
    ...
    <el-table :data="tableData" border style="width:100%" :height="tHeight" class="table-box">
      ...
      <el-table-column label="游戏名称" prop="title"></el-table-column>
      <el-table-column width="120" label="游戏难度" prop="level"></el-table-column>
      <el-table-column width="120" label="游戏分类" prop="type"></el-table-column>
      <el-table-column width="120" label="参与人数" prop="count"></el-table-column>
      <el-table-column width="160" label="日期" prop="date"></el-table-column>
